...
class ProfileController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('employer.profile.edit')->with('message', 'Employer information updated successfully!');
    }
    ...
    public function address(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('employer.profile.edit')->with('message', 'Employer address updated successfully!');
    }
    ...
    public function image(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('employer.profile.edit')->with('message', 'Employer image updated successfully!');
    }

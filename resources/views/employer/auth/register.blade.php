<x-app-layout>
    <x-slot:title>Register Employer</x-slot>

    <div class="flex justify-center items-center h-screen">
        <div class="rounded-lg shadow-md p-8 w-[60%]">
            <h1 class="text-3xl font-semibold mb-4">Employer Registration</h1>
            ...
            <form method="POST" action="{{ route('employer.register') }}">
                ...
                <div class="flex items-center justify-between mt-4">
                    <a class="underline text-lg block" href="{{ route('employer.login') }}">

<x-app-layout>
    <x-slot:title>Employer Profile</x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 shadow-md rounded-md">
                <div class="max-w-xl">
                    @include('employer.profile.partials.update-profile-image-form')
                </div>
            </div>
            ...
            <div class="p-4 sm:p-8 shadow-md rounded-md">
                <div class="max-w-xl">
                    @include('employer.profile.partials.update-profile-address-form')
                </div>
            </div>

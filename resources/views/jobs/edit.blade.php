    ...
    <x-slot:title>Update Job</x-slot>
                ...
                <div class="rounded-lg shadow-md p-8 shadow-black w-[75%] my-10">
                    ...
                    <form method="POST" action="{{ route('jobs.update', ['id' => $job->id]) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="title" type="text" name="title" :value="old('title', $job->title)" required
                                autocomplete="title" />
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description"
                                ...
                                autocomplete="description">{{ old('description', $job->description) }}</textarea>
                            <x-input-error class="mt-2" :messages="$errors->get('description')" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="location" :value="__('Job Location')" />
                            <x-text-input id="location" type="text" name="location" :value="old('location', $job->location)"
                        ...
                        <div class="mt-4">
                            ...
                            <select id='type' name='type' class="mt-2 w-full px-4 py-2 rounded-md border border-gray-300"
                                value="{{ old('type', $job->type) }}" required autofocus autocomplete="type">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="salary" type="text" name="salary" :value="old('salary', $job->salary)"
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="deadline" type="date" name="deadline" :value="old('deadline', $job->deadline)"
                        ...
                        <div>
                            ...
                            <select id='is_active' name='is_active'
                                ...
                                value="{{ old('is_active', $job->is_active) }}" required autofocus autocomplete="is_active">
        ...
        @else
            <div class="flex justify-center items-center h-full">
                <div class="rounded-lg shadow-md p-8 shadow-black w-[75%] my-10">
                    <h1 class="text-3xl font-semibold mb-4">Update Job Post</h1>
                    <p class="text-gray-500">You are not the owner of this company.</p>
                </div>
            </div>
        @endif
</x-app-layout>
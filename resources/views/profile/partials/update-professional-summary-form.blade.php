<section>
    <div>
        ...
        <p class="mt-1 text-lg text-gray-800">{{ __("Update your professional summary") }}</p>
    </div>
    ...
    <form method="post" action="{{ route('profile.update.professional') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <textarea id="professional_summary" name="professional_summary"
                ...
                autocomplete="professional_summary">{{ old('professional_summary', $user->professional_summary) }}</textarea>

<section>
    ...
    <form method="post" action="{{ route('profile.update.resume') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        @csrf
        @method('patch')
        <div>
            @if($user->resume)
        ...
        <div>
            ...
            <x-text-input id="resume" name="resume" type="file" class="mt-1 w-full px-4 py-2 rounded-md border border-gray-300 cursor-pointer" :value="old('resume', $user->resume)" required autofocus autocomplete="resume" />

<section>
    <div>
        ...
        <p class="mt-1 text-lg text-gray-800">{{ __("Update your social links") }}</p>
    </div>
    ...
    <form method="post" action="{{ route('profile.update.social') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="linkedin_url" name="linkedin_url" type="url" class="mt-1 block w-full"
                :value="old('linkedin_url', $user->linkedin_url)" required autofocus autocomplete="linkedin_url" />
        ...
        <div>
            ...
            <x-text-input id="github_url" name="github_url" type="url" class="mt-1 block w-full"
                :value="old('github_url', $user->github_url)" required autofocus autocomplete="github_url" />
        ...
        <div>
            ...
            <x-text-input id="website_url" name="website_url" type="url" class="mt-1 block w-full"
                :value="old('website_url', $user->website_url)" required autofocus autocomplete="website_url" />

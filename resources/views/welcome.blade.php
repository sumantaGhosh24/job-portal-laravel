    ...
    <x-slot:title>Welcome</x-slot>
        ...
        <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap py-16">
            <div class="w-full md:w-[45%]">
                <img src="{{ asset('images/hero.jpg') }}" alt="Hero Image"
                    class="w-full rounded-lg shadow-lg h-[350px]" />
            </div>
            <div class="w-full md:w-[45%]">
                <h2 class="text-3xl font-semibold my-5">Best Job Searching Portal</h2>
                <p class="text-gray-600 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
                    aliquam voluptas totam earum commodi facilis illum rem excepturi vel perferendis quae, dicta dolorum
                    necessitatibus aspernatur libero doloremque aut quod? Libero culpa id quia deleniti tempore ea error
                    molestiae voluptatem harum. </p>
                <a href="{{ route('login') }}" class="btn">Search Job</a>
                <a href="{{ route('login') }}" class="btn">Post Job</a>
            </div>
        </div>
        ...
        <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
            <div class="w-full md:w-[45%]">
                ...
                <p class="text-gray-600 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
                    aliquam voluptas totam earum commodi facilis illum rem excepturi vel perferendis quae, dicta dolorum
                    necessitatibus aspernatur libero doloremque aut quod? Libero culpa id quia deleniti tempore ea error
                    molestiae voluptatem harum. Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt autem
        ...
        <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
            ...
            <div class="w-full md:w-[45%]">
                ...
                <p class="text-gray-600 mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
                    aliquam voluptas totam earum commodi facilis illum rem excepturi vel perferendis quae, dicta dolorum
                    necessitatibus aspernatur libero doloremque aut quod? Libero culpa id quia deleniti tempore ea error
                    molestiae voluptatem harum. Blanditiis, ipsam. Velit illum a magnam dolore natus assumenda ullam
                    dolorem molestias dicta id odio error voluptatum repellat soluta, doloribus consequuntur aperiam
                    reiciendis alias quibusdam dolorum similique architecto? Hic asperiores in laborum vel amet totam.
                </p>
        ...
        <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
            <div class="w-full md:w-[45%] mb-5">
                ...
                <a href="{{ route('login') }}" class="btn">Employer Login</a>
                <a href="{{ route('register') }}" class="btn">Employer Register</a>
            </div>
            <div class="w-full md:w-[45%]">
        ...
        <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
            ...
            <div class='w-full md:w-[45%]'>
                ...
                <p class="text-gray-600 mb-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione quos
                    doloremque temporibus obcaecati vero. Eveniet exercitationem odit debitis natus nihil.</p>
                ...
                <div class="flex-auto w-full md:w-5/12 md:mr-5 mb-5 shadow-lg rounded-xl">
                    ...
                    <div class="p-5">
                        ...
                        <p class="text-sm font-light leading-6 mb-3 lg:font-medium">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus eos vel eius tempore itaque
                            omnis totam, maiores ipsum quos commodi est. Reprehenderit eaque voluptatem, magnam amet
        ...
        <div class="container mx-auto mt-10">
            ...
            <p class='text-gray-600 mb-5'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo
                perspiciatis nam rem cumque quibusdam ipsa cupiditate, nemo iure, possimus labore saepe officia impedit
                unde dolor dolores. Natus voluptatum iure iusto odit eius esse.
            <div class="flex items-center justify-between flex-wrap">
                <div class="flex-auto w-full md:w-5/12 md:mr-5 mb-5">
                    <form action="#" class="shadow-xl rounded-2xl p-5">
                        <div>
                            <input type="text" name="name" id="name" placeholder="enter your name"
                                class="w-full p-2 mb-3 rounded-lg text-black placeholder:text-slate-800 placeholder:capitalize outline-0 border border-blue-500 focus:ring-4 focus:ring-blue-200" />
                        </div>
                        <div>
                        ...
                        <div>
                            <textarea name="message" id="message" placeholder="enter your message"
                                class="w-full p-2 mb-3 rounded-lg text-black placeholder:text-slate-800 placeholder:capitalize outline-0 border border-blue-500 focus:ring-4 focus:ring-blue-200"></textarea>
                        </div>
        ...
        <footer class="bg-blue-800">
            <div class="container px-10 mx-auto mt-10 py-5 flex items-center justify-between flex-wrap">
                <div class="flex-auto w-full md:w-5/12 md:mr-5 lg:w-3/12 mx-auto mb-5">
                    ...
                    <p class="mb-3 text-gray-50 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum
                        nisi at atque perspiciatis velit quis. Aperiam veritatis dolore dolorem nulla consequatur

<x-app-layout>
    ...
    <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap py-16">
        <div class="w-full md:w-[45%]">
            <img src="{{ asset('images/hero.jpg') }}" alt="Hero Image" class="w-full rounded-lg shadow-lg h-[350px] dark:shadow-gray-300" />
        </div>
        <div class="w-full md:w-[45%]">
            <h2 class="text-3xl font-semibold my-5">Best Job Searching Portal</h2>
            <p class="text-gray-600 mb-5 dark:text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam necessitatibus aspernatur libero doloremque aut quod? Libero culpa id quia deleniti tempore ea error molestiae voluptatem harum.</p>
            <a href="{{ route('login') }}">
    ...
    <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
        ...
        <div class="w-full md:w-[45%]">
            <img src="{{ asset('images/feature-2.jpg') }}" alt="Feature Image" class="w-full rounded-lg shadow-lg h-[350px] dark:shadow-gray-300" />
        </div>
    </div>

    <div class="container mx-auto flex justify-around space-x-4 mb-10 flex-wrap">
        <div class='w-full md:w-[45%]'>
            <img src="{{ asset('images/achievement.jpg') }}" alt="Achievement Image" class="w-full rounded-lg shadow-lg h-[350px] dark:shadow-gray-300" />
        </div>
        <div class='w-full md:w-[45%]'>
            <h2 class="text-3xl font-semibold my-5">Our Alltime Achievement</h2>
            <p class="text-gray-600 mb-5 dark:text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ratione quos doloremque temporibus obcaecati vero. Eveniet exercitationem odit debitis natus nihil.</p>
        ...
        <div class="flex items-center justify-between flex-wrap">
            <div class="flex-auto w-full md:w-5/12 md:mr-5 mb-5 shadow-lg rounded-xl dark:shadow-gray-300">
                ...
                <div class="p-5">
                    ...
                    <p class="text-sm font-light leading-6 mb-3 lg:font-medium dark:text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Natus eos vel eius tempore itaque omnis totam, maiores ipsum quos commodi est. Reprehenderit eaque voluptatem, magnam amet mollitia voluptates architecto libero.</p>
                </div>
            </div>
            <div class="flex-auto w-full md:w-5/12 md:mr-5 mb-5 shadow-lg rounded-xl dark:shadow-gray-300">
    ...
    <div class="container mx-auto mt-10">
        ...
        <p class='text-gray-600 mb-5 dark:text-white'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo perspiciatis nam rem cumque quibusdam ipsa cupiditate, nemo iure, possimus labore saepe officia impedit unde dolor dolores. Natus voluptatum iure iusto odit eius esse.</p>
        <div class="flex items-center justify-between flex-wrap">
            <div class="flex-auto w-full md:w-5/12 md:mr-5 mb-5">
                <form action="#" class="shadow-xl rounded-2xl p-5 dark:shadow-gray-300">
                    <div>
                        <input type="text" name="name" id="name" placeholder="enter your name" class="w-full p-2 mb-3 rounded-lg text-black outline-0 border border-blue-500 focus:ring-4 focus:ring-blue-200 dark:text-white" />
                    </div>
                    <div>
                        <input type="email" name="email" id="email" placeholder="enter your email" class="w-full p-2 mb-3 rounded-lg text-black outline-0 border border-blue-500 focus:ring-4 focus:ring-blue-200 dark:text-white" />
                    </div>
                    <div>
                        <textarea name="message" id="message" placeholder="enter your message" class="w-full p-2 mb-3 rounded-lg text-black outline-0 border border-blue-500 focus:ring-4 focus:ring-blue-200 dark:text-white"></textarea>
                    </div>
    ...
    <footer class="bg-blue-800">
        <div class="container px-10 mx-auto mt-10 py-5 flex items-center justify-between flex-wrap">
            <div class="flex-auto w-full md:w-5/12 md:mr-5 lg:w-3/12 mx-auto mb-5">
                ...
                <p class="mb-3 text-gray-50 text-lg dark:text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cum nisi at atque perspiciatis velit quis. Aperiam veritatis dolore dolorem nulla consequatur excepturi debitis? Dolore, ducimus.</p>
                <div class="mb-3">
